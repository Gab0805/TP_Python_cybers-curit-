...
def insertion(): # insertion dans la table etudiant
    sql_insert = "INSERT INTO ETUDIANT (code_permanent,nom,prenom,date_naissance,specialte) VALUES ('jit111','jin','talla','1998-01-09','info')"
    cursor.execute(sql_insert)
    connect_db.commit()

def afficher():
    sql_afficher = "SELECT * FROM ETUDIANT" # ou "SELECT (code_permanent,nom,prenom,date_naissance,specialte) FROM ETUDIANT"
